...
! ===========================================================================
        ...
        real*8 angular (0:kmax, inter_max)
        real*8 answer (0:kmax)
...
! This is similarly done for xnormq and qsplit below.
        ...
        real*8 rmax (2)
        real*8 rjj (nsh_max, 2, 2*nqke + 1)
        real*8 sumj (nsh_max, 2)
        real*8 tkinetic (inter_max, nddke)
        real*8 xnormq (2, 0:nsh_max, 5)
